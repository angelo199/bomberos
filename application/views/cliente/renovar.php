						 	...
						 	<!-- Cabecera de la tabla  -->
							 	<thead> 
								 	...
								 	<tr>
											...
											<td class="active" width="10%" align="center">Unidad Tributaria</td>
											<td class="active" width="10%" align="center">N° Deposito</td>
											<td class="active" width="10%" align="center">F. Deposito</td>
										
										
											<td class="active" width="10%" align="center">Inmueble</td>
											<td class="active" width="10%" align="center">Direccion</td>
											<td class="active" width="10%" align="center">Municipio</td>
									
								 		
									 		<td class="active" width="10%" align="center">Parroquia</td>
											<td class="active" width="10%" align="center">Cargo</td>
											<td class="active" width="10%" align="center">Razon</td>
