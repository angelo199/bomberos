 ...
 width="100%" height="140px">
      ...
      <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li class="dropdown">
                          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Gestión de Inspección <span class="caret"></span></a>
                          <ul class="dropdown-menu" role="menu">
                              <li><a href="<?php echo base_url()?>Inspector/registrar">Registrar Resultado</a></li>
                              <li class="divider"></li>
                          </ul>
                  </li>
          
               
                <li><a href="#">Inspecciones <span class="badge"><?php echo $solicitudes->Solicitudes ?></span></a></li>
            ...
            <ul class="nav navbar-nav navbar-right">
                     <li class="dropdown">
                          ...
                          <ul class="dropdown-menu" role="menu">
                              ...
                              <p>  <center> <br> Inspector </p> <center>
                                  </li>
                                   <li class="divider"></li>
                                   <!-- Menu Body -->
                                  <li class="user-body">
